...
def init_db():
    ...
    """)
    db.execute("CREATE INDEX IF NOT EXISTS idx_catalog_schools_type_state ON catalog_schools (school_type, state)")
    db.execute("CREATE UNIQUE INDEX IF NOT EXISTS uniq_catalog_schools ON catalog_schools (school_type, state, name)")
